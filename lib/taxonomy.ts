...
export const CATEGORIES: CategoryDef[] = [
  ...
  { name: "Investment", type: "bills_fixed", notes: "Investment property costs: ING/Ashby loan interest, fees and repayments, land tax, ASIC, rates. Repayment legs (CBA out, ING in) cancel, so only interest is a net cost" },
