...
export const CATEGORIES: CategoryDef[] = [
  ...
  { name: "Property Interest (ING)", type: "bills_fixed", notes: "Interest and fees on the ING/Ashby investment loan — the real cost of that loan; principal payments are transfers (Investment) and stay out of expenses" },
  ...
  { name: "Investment", type: "transfers", notes: "Property capital, land tax, ASIC, and Ashby Loan principal transfers — the loan's interest and fees are under Property Interest (ING)" },
